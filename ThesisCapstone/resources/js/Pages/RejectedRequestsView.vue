    ...
    <div class="main">
      ...
      <div class="dashboard">
        <div class="bg-white p-6 rounded-xl shadow">
          <h2 class="text-2xl font-bold mb-6">Rejected Requests</h2>

          <div v-if="loading" class="text-gray-500">Loading rejected requests...</div>
          ...
          <div v-else>
            ...
            <p v-else class="italic text-gray-500">No rejected requests found.</p>
          </div>
        </div>
      </div>
    </div>
